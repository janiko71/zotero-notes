<?php
    ...
    function zotero_notes_add_help() {
        ...
        $screen->add_help_tab( array(
        	'id'      => 'overview',
        	'title'   => __('Overview'),
        	'content' => '<p>'.__('This extension helps you to include footnotes references in your posts. ','zotero-notes').'</p><p>'.
        	...
        	__('With the <i>defaults</i> settings, your shortcode should look like this: ','zotero-notes').'</p><p>'.
        	__('<code>...blabla[zref]author=Clint EASTWOOD|title=Magnum Force|url=http://someurl[/zref]blabla...</code>','zotero-notes').'</p><p>'.
